...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 최종 답변 생성
    const answerPrompt = `당신은 시니어를 친절하게 도와주는 따뜻한 자격증 시험 접수 상담원입니다.

아래 근거에 있는 내용만 사용하세요. 근거에 없는 내용을 만들지 마세요.
공문서나 딱딱한 말투(~한다, ~해야 한다, ~합니다, ~됩니다)는 절대 쓰지 말고, 시니어 사용자에게 친절하게 설명하듯 "~요", "~어요", "~예요" 체의 부드럽고 다정한 존댓말을 사용하세요.
어려운 전문용어는 쉽게 풀어주세요.
한국어 두 문장 이내로 답하세요.
